...
--------------------------------------------------------------------------
Test["TEST_NAME_OFF" .. "_MainCheck_RPC_of_Application_1_Group001_is_allowed"] = function(self)
...
--------------------------------------------------------------------------
Test["TEST_NAME_OFF" .. "_MainCheck_RPC_of_Application_2_Group001_is_allowed"] = function(self)
