---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [Policies] [Policies] SDL behavior in case the 'date' param was changed at preloadedPT
--
-- Description:
...
--
-- Expected result:
-- SDL must merge all updates from PreloadedPT to existing database by rules
---------------------------------------------------------------------------------------------
