...
-- Description:
-- User consent for functional groups of two mobile devices (Mobile №1 is consented, Mobile №2 is not consented)
-- with the same mobile applications registered
--
-- Preconditions:
-- 1) SDL and HMI are started
-- 2) Mobile №1 and №2 are connected to SDL and Mobile №1 is consented, Mobile №2 is not consented
...
local function connectMobDevices()
  common.connectMobDevice(1, devices[1], true)
