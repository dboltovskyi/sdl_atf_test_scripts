---------------------------------------------------------------------------------------------
-- Requirement summary:
--      [Policies] DISALLOWED: <app id> policies and "keep_context" validation
--
-- Description:
--    Validation of "keep_context" section in case "keep_context:false" and <app id> policies are assigned to the application
--     1. Used preconditions:
--        SDL and HMI are started
--        Overwrite preloaded PT(with "keep_context"=false in <app id> policies)
--
--     2. Performed steps
...
local function Set_keep_context_false_for_appId_policies()
...
function Test.Precondition_Set_keep_context_false_for_appId()
  Set_keep_context_false_for_appId_policies()
end
