...
local allowed_func
local p = "Wrong SDL bahavior: there are app permissions for consent, isPermissionsConsentNeeded should be true"
        ...
        if (data.params.appPermissionsConsentNeeded== true) then
          ...
          :Do(function()
              ...
              EXPECT_HMIRESPONSE(ReqIDGetUserFriendlyMessage,
                {result = {
                    code = 0,
                    messages = {{messageCode = "AppPermissions"}},
          ...
          commonFunctions:userPrint(31, p)
          return false
        end
      end)
